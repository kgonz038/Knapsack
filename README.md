...
This program takes user input to get Knapsack info like: max capacity weight, total # of items, value of each item, and the weight of the items. Using the info entered by the user, it will be used in both implementations of the Knapsack algorithms, both 0/1 Knapsack Dynamic and Fractional Knapsack Greedy. 

<img src="knapsack-project.jpg">

## [Java file](https://github.com/kgonz038/Knapsack/blob/main/knapsack_kimberly_gonzalez.java)
